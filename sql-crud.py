...
# Step 1: Update the connection to use the correct socket path for Gitpod
...
deepeshkumar_patel = Programmer(
    first_name="DeepeshKumar",
    last_name="Patel",
    gender="Male",
    nationality="British",
    famous_for="King"
...
# session.add(deepeshkumar_patel)
